...
void c_gui::render()
{
	...
	gui->begin("menu", nullptr, var->window.flags);
	{
		...
		gui->begin_content("content", gui->window_size(), SCALE(elements->window.padding), SCALE(elements->widgets.spacing.x, elements->window.padding.y), window_flags_no_scroll_with_mouse | window_flags_no_scrollbar);
		{
			...
			{
				widgets->top_bar("t.me/uiengine", "22.08.2025");
				gui->sameline();
			...
			if(var->gui.active_section == 0)
			{
				...
				gui->begin_content("s_g_content", SCALE(0, 0), SCALE(0, 0), SCALE(elements->window.padding));
				{
					...
					{
						widgets->games_child("fps_id", "FPS", "H", "25.201");
						{
						...
						widgets->games_child("battle_royale_id", gui->language("BATTLE ROYALE", "КОРОЛЕВСКАЯ БИТВА"), "I", "20.186");
						{
					...
					if (var->gui.active_stage == 2)
						widgets->product_page(var->gui.cs_player, 0, "Counter-Strike 2", gui->language("Step into the intense, tactical world of Counter-Strike 2 armed with an unrivaled advantage. Our cheat is meticulously crafted for the Source 2 engine, offering a seamless and powerful experience. Gain complete tactical awareness with our crystal-clear ESP, revealing enemy positions, health, and equipment through any obstacle. Beyond core combat, enhance your gameplay with a full-featured Skin Changer to equip any cosmetic you desire.", "Войдите в напряженный, тактический мир Counter-Strike 2, вооружившись непревзойденным преимуществом. Наш чит тщательно разработан для движка Source 2, обеспечивая бесперебойную и мощную работу. Получите полную тактическую осведомленность благодаря нашему кристально чистому ESP, позволяющему видеть позиции врагов, их здоровье и снаряжение сквозь любые препятствия. Помимо основного боя, вы сможете улучшить свой игровой процесс с помощью полнофункционального скин-чейнджера, позволяющего надеть любую косметику по вашему желанию."), "12.679", "22.07.25", "Undetected", "146");
					if (var->gui.active_stage == 4)
						widgets->product_page(var->gui.apex_player, 4, "Apex Legends", gui->language("Step into the intense, tactical world of Counter-Strike 2 armed with an unrivaled advantage. Our cheat is meticulously crafted for the Source 2 engine, offering a seamless and powerful experience. Gain complete tactical awareness with our crystal-clear ESP, revealing enemy positions, health, and equipment through any obstacle. Beyond core combat, enhance your gameplay with a full-featured Skin Changer to equip any cosmetic you desire.", "Войдите в напряженный, тактический мир Counter-Strike 2, вооружившись непревзойденным преимуществом. Наш чит тщательно разработан для движка Source 2, обеспечивая бесперебойную и мощную работу. Получите полную тактическую осведомленность благодаря нашему кристально чистому ESP, позволяющему видеть позиции врагов, их здоровье и снаряжение сквозь любые препятствия. Помимо основного боя, вы сможете улучшить свой игровой процесс с помощью полнофункционального скин-чейнджера, позволяющего надеть любую косметику по вашему желанию."), "12.679", "22.07.25", "Undetected", "146");
					if (var->gui.active_stage == 5)
						widgets->product_page(var->gui.fortnite_player, 2, "Fortnite", gui->language("Step into the intense, tactical world of Counter-Strike 2 armed with an unrivaled advantage. Our cheat is meticulously crafted for the Source 2 engine, offering a seamless and powerful experience. Gain complete tactical awareness with our crystal-clear ESP, revealing enemy positions, health, and equipment through any obstacle. Beyond core combat, enhance your gameplay with a full-featured Skin Changer to equip any cosmetic you desire.", "Войдите в напряженный, тактический мир Counter-Strike 2, вооружившись непревзойденным преимуществом. Наш чит тщательно разработан для движка Source 2, обеспечивая бесперебойную и мощную работу. Получите полную тактическую осведомленность благодаря нашему кристально чистому ESP, позволяющему видеть позиции врагов, их здоровье и снаряжение сквозь любые препятствия. Помимо основного боя, вы сможете улучшить свой игровой процесс с помощью полнофункционального скин-чейнджера, позволяющего надеть любую косметику по вашему желанию."), "12.679", "22.07.25", "Undetected", "146");
